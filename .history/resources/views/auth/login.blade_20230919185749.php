            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="w-full flex flex-col items-center p-10" >
                    ...
                    <div class="w-3/4 mb-6">
                        <input type="text" name="mobile" id="mobile" class="w-full text-right py-4 px-8 bg-black/20 placeholder:font-semibold rounded hover:ring-1 outline-black/20" placeholder="شماره همراه">
                        <x-input-error :messages="$errors->get('mobile')" class="mt-2" />
                    </div>
                    <!-- password input -->
                    <div class="w-3/4 mb-6">
                        <input type="password" name="password" id="password" class="w-full text-right py-4 px-8 bg-black/20 placeholder:font-semibold rounded hover:ring-1 outline-black/20 " placeholder="گذرواژه">
