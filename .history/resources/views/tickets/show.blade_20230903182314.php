<x-app-layout>
    ...
    <div class="p-4">
      @if ($ticket->status == 'closed')
            <span class="bg-gray-100 text-gray-800 text-lg inline font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
            {{ $ticket->getStatusText() }}
            </span>
        @elseif ($ticket->status == 'open')
            <span class="bg-blue-100 text-blue-800 text-lg inline font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
            {{ $ticket->getStatusText() }}
            </span>
        @elseif ($ticket->status == 'solved')
            <span class="bg-green-100 text-green-800 text-lg inline font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900">
            {{ $ticket->getStatusText() }}
            </span>
        @elseif ($ticket->status == 'new')
            <span class="bg-yellow-100 text-yellow-800 text-lg inline font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-200 dark:text-yellow-900">
            {{ $ticket->getStatusText() }}
            </span>
        @endif
   </div>
